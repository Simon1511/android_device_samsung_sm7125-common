...
void fixupMixers() {
    ...
    if (strcmp(simslot, "0") == 0 || strcmp(simslot, "1") == 0) {
        ALOGD("In phone call");
        if (strcmp(a2dpcall, "true") == 0 && strcmp(ampstatus, "ENABLE") == 0) {
            ALOGD("In A2DP call");
    ...
    if (voipstatus == 1) {
        ALOGE("In VoIP call");
        if (strcmp(epcstatus, "true") == 0 && strcmp(spkstatus, "false") == 0 && strcmp(ampstatus, "DISABLE") == 0) {
            ALOGD("Setting earpiece mixers");
            setEarpieceVoipMixers(true);
        }

        if (strcmp(epcstatus, "false") == 0 && strcmp(spkstatus, "true") == 0 && strcmp(ampstatus, "ENABLE") == 0) {
...
Result ParametersUtil::setParametersImpl(const hidl_vec<ParameterValue>& context,
    ...
    for (size_t i = 0; i < parameters.size(); ++i) {
        ...
        if (parameters[i].key == "a2dp_call" || parameters[i].key == "voip_call") {
