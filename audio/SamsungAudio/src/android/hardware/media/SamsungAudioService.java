...
public class SamsungAudioService extends Service {
    ...
    public void onCreate() {
        ...
        BluetoothAdapter adapter = bluetoothManger.getAdapter();
        ...
        mRunnable = new Runnable() {
            public void run() {
                ...
                if (SystemProperties.get("vendor.audio.a2dp.call").equals("true") && mAudioManager.getMode() == AudioManager.MODE_IN_CALL && adapter.isEnabled()) {
                    /*if (DEBUG)*/ Log.e(TAG, "setting parameters");
