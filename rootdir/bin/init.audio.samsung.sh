...
do
	...
	btstatussim1=$($tinymix "VoiceMMode1_Tx Mixer TX_CDC_DMA_TX_3_MMode1" --v | awk '{ print $1 }')
	btstatussim2=$($tinymix "VoiceMMode2_Tx Mixer TX_CDC_DMA_TX_3_MMode2" --v | awk '{ print $1 }')
	...
	if [[ $btstatussim1 == "On" ]] || [[ $btstatussim2 == "On" ]]; then
